export const myproductExperience = {
  id: 'myproduct',
  slug: 'myproduct',
...
- Parsed contacts of about 1000 flower shops from Google Maps with basic info about them (using home brewed web-parser)

## What is planned:

- Register legal entity and establish EU bank accounts (currently I have Ukrainian PE, so looking for the partnership)
- Sendout email + Whatsapp campaign
- Hire support
- Onboard first 50 clients within 6 months
