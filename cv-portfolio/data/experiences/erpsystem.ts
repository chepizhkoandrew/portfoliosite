export const erpsystemExperience = {
  ...
  achievements: [
    'Led 50+ engineers in building comprehensive agricultural ERP system',
    'Managed complex domain (agriculture, logistics, resource optimization)',
    'Coordinated system handling 7,500 fields and 12,000 vehicle fleet',
    'Maintained scope and delivered on client expectations',
    'Successfully navigated complex stakeholder landscape',
  ],
